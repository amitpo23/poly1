...
class TestTradingPolicyContract(unittest.TestCase):
    ...
    def test_secret_free_examples_match_policy(self):
        ...
        self.assertIn('EXTERNAL_CONVICTION_AGGREGATOR_PROVIDERS="manifold,metaculus,kalshi,alpaca_market_data,crypto_exchange_tape,technical_signal,clob_whale"', env_text)
