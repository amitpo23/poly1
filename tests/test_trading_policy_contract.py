...
class TestTradingPolicyContract(unittest.TestCase):
    ...
    def test_secret_free_examples_match_policy(self):
        ...
        self.assertIn('EXTERNAL_CONVICTION_AGGREGATOR_PROVIDERS="manifold,metaculus,kalshi,alpaca_market_data,openbb_market_data,crypto_exchange_tape,technical_signal,clob_whale"', env_text)
        self.assertIn('META_BRAIN_WEIGHT_CRYPTO_TAPE="0.12"', env_text)
    ...
    def test_compose_has_operator_dashboard(self):
        ...
        self.assertIn('RUNTIME_AGENT: market_scanner', compose)
        self.assertNotIn('SCANNER_POLL_SEC: "60"', compose)
